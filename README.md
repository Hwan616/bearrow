...
**Phase 6(기능 고도화·UI 완성) 전 항목 완료.** Phase 0–6 전체가 완료된 상태이며 Phase 7(스토어 출시) 준비 단계다. 세부 진행 현황은 `docs/BACKLOG.md` 참고.
...
| 6 | 기능 고도화·UI 완성 (카테고리 관리 · CRUD · 공휴일 · 반응형 · 외부 캘린더) | ✅ 완료 |
...
| 6.7 | 외부 캘린더 연동 (Google Calendar 동기화 트리거, iCloud CalDAV 가져오기) | 2026-07-06 | ✅ |
